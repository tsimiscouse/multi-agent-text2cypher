...
class InstructionsGenerator:
    ...
    def __init__(
        ...
        """
        Initialize Instructions Generator agent.
    ...
    def _load_prompts(self):
        ...
        try:
            ...
            self.logger.info("Instructions generator prompt loaded")
...
**Correction Instructions:**"""
    ...
    def generate(
        ...
        try:
            ...
            self.logger.info(f"Generated instructions ({metadata['tokens_used']} tokens)")
